...
@section("content")
    <div id="index__wrapper" class="container-fluid py-4">
        <div class="container my-0 my-md-5 py-2 py-md-3 pb-md-5 w-auto text-center">
            <div class="row">
                <div class="col-10 col-md-5 offset-1 offset-md-1 text-center text-md-start">
                    <img id="index__image" class="img mt-1 mt-md-5 mx-auto ms-md-0" src="{{ asset('images/icon.png') }}" alt="Larabook" />
                    <p class="d-inline-block ps-4 fs-3 lead w-100">
                        Connect with friends and the world around you on Larabook.
                    </p>
                </div>
                <div class="col-12 col-md-6">
                    <div id="index__card-wrapper" class="d-inline-block">
                        {{-- login panel --}}
                                    ...
                                    <div class="row">
                                        ...
                                        @if(Route::has('password.update'))
                                            <div class="col-form-label mt-3 mb-2">
                                                <a class="text-decoration-none text-link" href="{{ route('password.update') }}">Forgot password?</a>
                                            </div>
                                        @endif
                                        {{-- hr --}}
                                        <div class="col-12">
                        ...
                        <span class="d-block mt-4" style="font-size: 1em !important; font-family: Helvetica, sans-serif !important;">
                            <a class="fw-bold text-decoration-none text-link text-dark" href="#">Create a Page</a> for a celebrity, brand or business.
                        </span>
                    </div>
                </div>
            </div>
